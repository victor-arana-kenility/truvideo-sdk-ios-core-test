...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TruvideoSdk",
            url: "https://github.com/victor-arana-kenility/truvideo-sdk-ios-core-test/releases/download/0.0.1/TruvideoSdk.xcframework.zip",
            checksum: "190af896061bc67a90a1cfa2df5aa520150d634a7c2dc2970b7aa70695629c53"
        ),
        .binaryTarget(
            name: "Common",
